...
export class StoreAsync<K, T> implements IKeyValueStoreAsync<K, T> {
	...
	public constructor(private readonly opts: { tableName: string; connection: DynamoDB.ClientConfiguration }) {
		this.store = new DynamoDB(opts.connection);
	}
	...
	public async flush(): Promise<boolean> {
		// @TODO: remove
		try {
			await new DynamoDB(this.opts.connection)
				.createTable({
